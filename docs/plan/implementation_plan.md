...
| F15 | Customer Google login | done | TBD | 2026-03-25 | requirements, ui_spec, system_design, api_contracts, data_model, implementation_plan, status_board, coding_log, test_plan | yes | add Google OAuth sign-in for customers |
